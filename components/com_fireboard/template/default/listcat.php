					...
					if($letPass || $is_Mod){
						...
						<td class="td-2" align="left">
							<div class="<?php echo $boardclass ?>thead-title fbl">
								...
								if($singlerow->locked){
									echo $fbIcons->forumlocked ? '&nbsp;&nbsp;<img src="' . JB_URLICONSPATH . '' . $fbIcons->forumlocked . '" border="0" alt="' . _GEN_LOCKED_FORUM . '" title="' . _GEN_LOCKED_FORUM . '"/>' : '&nbsp;&nbsp;<img src="' . JB_URLEMOTIONSPATH . 'lock.gif"  border="0" alt="' . _GEN_LOCKED_FORUM . '">';
									$lockedForum = 1;
								}

								if($singlerow->review){
									echo $fbIcons->forummoderated ? '&nbsp;&nbsp;<img src="' . JB_URLICONSPATH . '' . $fbIcons->forummoderated . '" border="0" alt="' . _GEN_MODERATED . '" title="' . _GEN_MODERATED . '"/>' : '&nbsp;&nbsp;<img src="' . JB_URLEMOTIONSPATH . 'review.gif" border="0"  alt="' . _GEN_MODERATED . '">';
									$moderatedForum = 1;
								}
								?>
							</div>
							...
							if(count($forumparents) > 0){
								...
								<div class="<?php echo $boardclass?>thead-child">
									<div class="<?php echo $boardclass?>cc-childcat-title fbs">
										<b><?php if(count($forumparents) == 1){
											echo _FB_CHILD_BOARD;
										} else{
											echo _FB_CHILD_BOARDS;
										} ?>:</b>
									</div>
						...
						if($numtopics != 0){
							...
							<td class="td-5" align="left">
								...
								<div class="<?php echo $boardclass ?>latest-subject-by fbs">
									...
									echo $fbIcons->latestpost ? '<img src="' . JB_URLICONSPATH . '' . $fbIcons->latestpost . '" border="0" alt="' . _SHOW_LAST . '" title="' . _SHOW_LAST . '" />' : '  <img src="' . JB_URLEMOTIONSPATH . 'icon_newest_reply.gif" border="0"  alt="' . _SHOW_LAST . '" />'; ?> </a>
								</div>
							</td>
                                </tr>
                                    <?php
