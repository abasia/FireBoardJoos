<?php
/**
 * @version $Id: myprofile_summary.php 433 2007-12-03 14:33:47Z miro_dietiker $
 * Fireboard Component
 * @package Fireboard
			...
			<div class="<?php echo $boardclass; ?>_bt_cvr4">
				<div class="<?php echo $boardclass; ?>_bt_cvr5">
					<table class="fb_blocktable" id="fb_forumprofile_sub" border="0" cellspacing="0" cellpadding="0" width="100%">
						...
						<tr>
							<th colspan="2">
								<div class="fb_title_cover"><span class="fb_title"><?php echo _FB_MYPROFILE_SUMMARY; ?></span></div>
							</th>
						</tr>
						</thead>
						...
						<tr>
							<td width="30%"><b><?php echo _FB_MYPROFILE_NAME; ?></b></td>
							<td><?php echo $juserinfo->name; ?></td>
						</tr>
						<tr>
							<td width="30%"><b><?php echo _FB_MYPROFILE_USERNAME; ?></b></td>
