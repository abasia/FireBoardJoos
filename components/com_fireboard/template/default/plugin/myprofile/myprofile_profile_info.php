...
<?php echo _HTML_YES; ?>
				...
				<td ><textarea style = "width: <?php echo $fbConfig['rtewidth']?>px; height: 60px;" class = "inputbox" onMouseOver = "textCounter(this.form.message,this.form.counter,<?php echo $fbConfig['maxSig'];?>);" onClick = "textCounter(this.form.message,this.form.counter,<?php echo $fbConfig['maxSig'];?>);"
