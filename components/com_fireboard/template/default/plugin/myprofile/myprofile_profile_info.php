<?php
/**
 * @version $Id: myprofile_profile_info.php 485 2007-12-13 13:52:18Z miro_dietiker $
 * Fireboard Component
 * @package Fireboard
					...
					<form action="<?php echo sefRelToAbs(JB_LIVEURLREL . '&amp;func=myprofile&amp;do=saveprofileinfo'); ?>" method="post" name="postform">
						...
						<table class="fb_blocktable" id="fb_forumprofile_sub" border="0" cellspacing="0" cellpadding="0" width="100%">
							...
							<tr>
								...
								<td><input name="personalText" size="50" maxlength="25" value="<?php echo $userinfo->personalText?>" type="text"/></td>
							</tr>
							<tr>
							<tr>
								<td width="40%">
							...
							<tr>
								<td width="40%"><b><?php echo _FB_MYPROFILE_ICQ; ?> </b>

									<div class="smalltext"><?php echo _FB_MYPROFILE_ICQ_DESC; ?></div>
								</td>
								<td><input name="ICQ" size="24" value="<?php echo $userinfo->ICQ;?>" type="text"/></td>
							</tr>
							<tr>
								<td width="40%"><b><?php echo _FB_MYPROFILE_AIM; ?> </b>

									<div class="smalltext"><?php echo _FB_MYPROFILE_AIM_DESC; ?></div>
								</td>
								<td><input name="AIM" maxlength="16" size="24" value="<?php echo $userinfo->AIM;?>" type="text"/></td>
							</tr>
							<tr>
								<td width="40%"><b><?php echo _FB_MYPROFILE_MSN; ?> </b>

									<div class="smalltext"><?php echo _FB_MYPROFILE_MSN_DESC; ?></div>
								</td>
								<td><input name="MSN" size="24" value="<?php echo $userinfo->MSN;?>" type="text"/></td>
							</tr>
							<tr>
								<td width="40%"><b><?php echo _FB_MYPROFILE_YIM; ?> </b>

									<div class="smalltext"><?php echo _FB_MYPROFILE_YIM_DESC; ?></div>
								</td>
								<td><input name="YIM" maxlength="32" size="24" value="<?php echo $userinfo->YIM;?>" type="text"/></td>
							</tr>
							<tr>
								<td width="40%"><b><?php echo _FB_MYPROFILE_SKYPE; ?> </b>

									<div class="smalltext"><?php echo _FB_MYPROFILE_SKYPE_DESC; ?></div>
								</td>
								<td><input name="SKYPE" maxlength="32" size="24" value="<?php echo $userinfo->SKYPE;?>" type="text"/></td>
							</tr>
							<tr>
								<td width="40%"><b><?php echo _FB_MYPROFILE_GTALK; ?> </b>

									<div class="smalltext"><?php echo _FB_MYPROFILE_GTALK_DESC; ?></div>
								</td>
								<td><input name="GTALK" maxlength="32" size="24" value="<?php echo $userinfo->GTALK;?>" type="text"/></td>
							</tr>
							<tr>
								<td width="40%"><b><?php echo _FB_MYPROFILE_WEBSITE_NAME; ?> </b>

									<div class="smalltext"><?php echo _FB_MYPROFILE_WEBSITE_NAME_DESC; ?></div>
								</td>
								<td><input name="websitename" maxlength="32" size="24" value="<?php echo $userinfo->websitename;?>" type="text"/></td>
							</tr>
							<tr>
								<td width="40%"><b><?php echo _FB_MYPROFILE_WEBSITE_URL; ?> </b>

									<div class="smalltext"><?php echo _FB_MYPROFILE_WEBSITE_URL_DESC; ?></div>
								</td>
							...
							<tr>
								...
								<td><textarea style="width: <?php echo $fbConfig->rtewidth?>px; height: 60px;" class="inputbox" onMouseOver="textCounter(this.form.message,this.form.counter,<?php echo $fbConfig->maxSig;?>);"
											  ...
											  name="message"><?php echo htmlspecialchars($userinfo->signature, ENT_QUOTES); ?></textarea>
									<br/>
							...
							<tr>
								<td colspan="2" align="center"><input type="submit" class="button" value="<?php echo _GEN_SUBMIT;?>"/></td>
							</tr>
							</tbody>
						</table>
