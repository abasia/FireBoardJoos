<?php
/**
 * @version $Id: myprofile_userdetails_form.php 412 2007-10-12 07:47:11Z florut $
 * Fireboard Component
 * @package Fireboard
				...
				<div class="<?php echo $boardclass; ?>_bt_cvr5">
					<form action="index.php" method="post" name="mosUserForm">
						...
						<table class="fb_blocktable" id="fb_forumprofile_sub" border="0" cellspacing="0" cellpadding="0" width="100%">
							...
							<tr>
								<th colspan="2">
									<div class="fb_title_cover"><span class="fb_title"><?php echo _FB_EDIT_TITLE; ?></span></div>
								</th>
							</tr>
							</thead>
							...
							<tr>
								<td width="30%"><?php echo _FB_YOUR_NAME; ?> </td>
