<?php
/**
 * @version $Id: summary.php 462 2007-12-10 00:05:53Z fxstein $
 * Fireboard Component
 * @package Fireboard
...
<div class="<?php echo $boardclass; ?>_bt_cvr1">
	<div class="<?php echo $boardclass; ?>_bt_cvr2">
			...
			<div class="<?php echo $boardclass; ?>_bt_cvr4">
				<div class="<?php echo $boardclass; ?>_bt_cvr5">
					<table class="fb_blocktable" id="fb_forumprofile_sub" border="0" cellspacing="0" cellpadding="0" width="100%">
						...
						<tr>
							<th colspan="2">
								<div class="fb_title_cover fbm"><span class="fb_title fbxl"><?php echo _FB_MYPROFILE_SUMMARY; ?></span></div>
						...
						<tr class="fb_sth fbs">
							<th colspan="2"><?php echo _FB_MYPROFILE_PERSONAL_INFO; ?></th>
						</tr>
      ...
      <td  class = "td-2 fbm"><?php echo $userinfo->name; ?></td>
						...
						<tr class="<?php echo $boardclass; ?>sectiontableentry1">
							<td class="td-1 fbm" width="40%"><b><?php echo _FB_MYPROFILE_USERNAME; ?></b></td>
							<td class="td-2 fbm" width="60%"><?php echo $userinfo->username; ?></td>
						</tr>
						...
						<tr class="fb_sth fbs">
							<th colspan="2"><?php echo _FB_MYPROFILE_ADDITIONAL_INFO; ?></th>
						</tr>
						...
						<tr class="<?php echo $boardclass; ?>sectiontableentry1">
							...
							<td class="td-2 fbm"><?php if($userinfo->gender == 1){
								echo _FB_MYPROFILE_MALE;
							} else if($userinfo->gender == 2){
								echo _FB_MYPROFILE_FEMALE;
							} else{
							}  ?></td>
						</tr>
							<?php } ?>
