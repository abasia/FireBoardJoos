							...
							<th align="left">
								<div class="fb_title_cover fbm">
									<a class="fb_title fbxl" href="<?php echo $whoislink;?>">
										...
										<?php if($totaluser == 1){
										echo _WHO_ONLINE_MEMBER;
									} else{
										echo _WHO_ONLINE_MEMBERS;
									} ?>
										<?php echo _WHO_AND; ?>
										<b><?php echo $totalguests; ?></b>
										<?php if($totaluser == 1){
										echo _WHO_ONLINE_GUEST;
									} else{
										echo _WHO_ONLINE_GUESTS;
									} ?>
									</a>
								</div>
