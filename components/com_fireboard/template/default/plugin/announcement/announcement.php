...
if($do == "read"){
	...
	<table class="<?php echo $boardclass; ?>forum-cat forumann" cellpadding="0" cellspacing="0" border="0"
		...
		<tbody>
		<tr>
			<td class="forumreadann">
				<div class="cat-title" style="background: url('<? echo "$mosConfig_live_site/components/com_fireboard/template/$fb_cur_template"; ?>/images/menu-bar.gif') repeat-x center;border:1px solid #878787;padding-left:8px;width:961px;"><h3><?php echo $anntitle; ?></h3></div>
				<?php
				if($annshowdate > 0){
					?>
				...
				if($is_editor){
					?>
					<div>
						<div id="bof-annmenu"><a href="<?php echo $editlink; ?>"><?php echo _ANN_EDIT; ?> </a> | <a href="<?php echo $deletelink; ?>"><?php echo _ANN_DELETE; ?> </a> | <a href="<?php echo $addlink; ?>"><?php echo _ANN_ADD; ?> </a> | <a
							href="<?php echo $showlink; ?>"><?php echo _ANN_CPANEL; ?> </a></div>
					</div>
					<?php
				}
				?>
...
if($is_editor){
	...
	<form action="<?php echo sefRelToAbs(JB_LIVEURL . '&amp;func=announcement&amp;do=add'); ?>" method="post" name="addform">
		<div align="center">
			<table class="bof-postmessage" width="100%" align="center">
				<tr>
					<td>
						<div align="center">
	...
	<form action="<?php echo sefRelToAbs(JB_LIVEURL . '&amp;func=announcement&amp;do=show'); ?>"
		...
		<div align="center">
			<table class="bof-postmessage" width="100%">
				<tr>
					<td>
						<div align="center">
