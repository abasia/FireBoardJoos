<?php
/**
 * @version $Id: announcementbox.php 462 2007-12-10 00:05:53Z fxstein $
 * Fireboard Component
 * @package Fireboard
		...
		<div class="<?php echo $boardclass; ?>_bt_cvr3">
			<div class="<?php echo $boardclass; ?>_bt_cvr4">
				<div class="<?php echo $boardclass; ?>_bt_cvr5">
					<table class="fb_blocktable" id="fb_announcement" border="0" cellspacing="0" cellpadding="0"
						   width="100%">
						<thead>
						<tr>
							<th align="left">
								...
								<img id="BoxSwitch_announcements__announcements_tbody" class="hideshow"
						...
						<tbody id="announcements_tbody">
							...
							<tr class="fb_sth">
								<th class="th-1 <?php echo $boardclass;?>sectiontableheader fbm" align="left">
									...
									|
									<a href="<?php echo $deletelink;?><?php echo $annID; ?>"><?php echo _ANN_DELETE; ?> </a>
									| <a href="<?php echo $addlink;?>"><?php echo _ANN_ADD; ?> </a> | <a
									href="<?php echo $showlink;?>"><?php echo _ANN_CPANEL; ?> </a>
								</th>
							</tr>
								<?php
							}
							...
							<td class="td-1 fbm" align="left">
								...
								<div class="anndesc">
									...
									if($anndescription != ""){
										?>
										&nbsp;&nbsp;&nbsp;<a
											href="<?php echo $readlink;?><?php echo $annID;?>"> <?php echo _ANN_READMORE; ?></a>
										<?php
									}
									?>
								</div>
