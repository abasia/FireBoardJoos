					...
					<table class="fb_blocktable" id="fb_morestat " border="0" cellspacing="0" cellpadding="0" width="100%">
						...
						<tr class="<?php echo $boardclass;?>sectiontableentry1">
							<td class="td-1" align="left">
								...
								<?php echo _STAT_LATEST_MEMBERS; ?>:<b>
			...
			<div class="<?php echo $boardclass; ?>_bt_cvr4">
				<div class="<?php echo $boardclass; ?>_bt_cvr5">
					<table class="fb_blocktable " id="fb_popusermsgmorestat" cellpadding="0" cellspacing="0" border="0" width="100%">
						...
						<tr class="<?php echo '' . $boardclass . '' . $tabclass[$k] . ''; ?>">
							<td class="td-1" align="left">
								<a href="<?php echo sefReltoAbs('index.php?option=com_fireboard&amp;Itemid=' . $Itemid . '&amp;func=fbprofile&amp;task=showprf&amp;userid=' . $poster->userid);?>"
								   title="<?php echo _STAT_USER_INFO . '&nbsp;'; ?><?php echo $poster->username;?>"><?php echo $poster->username; ?></a>
							</td>
							<td class="td-2">
								<img class="jr-forum-stat-bar" src="<?php echo JB_TMPLTMAINIMGURL . '/images/bar.gif';?>" alt="" height="10" width="<?php echo $barwidth;?>%"/>
							</td>
			...
			<div class="<?php echo $boardclass; ?>_bt_cvr4">
				<div class="<?php echo $boardclass; ?>_bt_cvr5">
					<table class="fb_blocktable " id="fb_popuserhitmorestat" cellpadding="0" cellspacing="0" border="0" width="100%">
						...
						<tr class="<?php echo '' . $boardclass . '' . $tabclass[$k] . ''; ?>">
							<td class="td-1" align="left">
								<a href="<?php echo sefReltoAbs('index.php?option=com_fireboard&amp;Itemid=' . $Itemid . '&amp;func=fbprofile&amp;task=showprf&amp;userid=' . $topprofile->user_id);?>"
								   title="<?php echo _STAT_USER_INFO . '&nbsp;'; ?><?php echo $topprofile->user;?>"><?php echo $topprofile->user; ?></a>
							</td>
							<td class="td-2">
								<img class="jr-forum-stat-bar" src="<?php echo JB_TMPLTMAINIMGURL . '/images/bar.gif';?>" alt="" height="10" width="<?php echo $barwidth;?>%"/>
							</td>
