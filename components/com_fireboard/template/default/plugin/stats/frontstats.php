<?php
/**
 * @version $Id: frontstats.php 520 2007-12-19 08:17:29Z fxstein $
 * Fireboard Component
 * @package Fireboard
...
if($fbConfig->showStats > 0){
	...
	$database->setQuery("SELECT m.*, m.time AS sendtime FROM #__fb_messages AS m" . "\n LEFT JOIN #__fb_categories AS c ON c.id = m.catid" . "\n LEFT JOIN #__users AS u ON u.gid >= c.pub_access" . "\n WHERE m.moved='0' AND u.id = $my->id AND c.published = 1 AND m.hold = 0" . "\n ORDER BY m.id DESC LIMIT 0,1");
						...
						<table class="fb_blocktable" border="0" cellspacing="0" cellpadding="0" width="100%">
							...
							<tr>
								<th align="left">
									<div class="fb_title_cover fbm">
										<a class="fb_title fbxl" href="<?php echo $statslink;?>"><?php echo _STAT_FORUMSTATS; ?></a>
									</div>
							...
							<tr class="<?php echo $boardclass;?>sectiontableentry1">
								...
								_STAT_YESTERDAY_OPEN_THREAD; ?>: <b> <?php echo $yesterdaystitle; ?></b> &nbsp; <?php echo _STAT_TODAY_TOTAL_ANSWER; ?>: <b> <?php echo $todaytotal; ?></b> &nbsp; <?php echo _STAT_YESTERDAY_TOTAL_ANSWER; ?>: <b> <?php echo $yesterdaytotal; ?></b>
									<br/>
									&raquo; <a href="<?php echo sefRelToAbs(JB_LIVEURLREL . '&amp;func=latest');?>"><?php echo _STAT_VIEW_RECENT_POSTS_ON_FORUM; ?></a> &raquo; <a href="<?php echo $statslink;?>"><?php echo _STAT_MORE_ABOUT_STATS; ?></a> &raquo; <a
									href="<?php echo $userlist;?>"><?php echo _STAT_USERLIST; ?></a>
								</td>
							</tr>
							</tbody>
						</table>
