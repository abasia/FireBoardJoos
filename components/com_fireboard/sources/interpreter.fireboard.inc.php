    ...
    function TagStandard(&$tns, &$tne, &$task, $tag) {
        ...
        switch (strtolower($tag->name)) {
            ...
            case 'highlight':
                ...
                break;
            case 'left':
                $tns = '<div style="width:100%;text-align:left" align="left">'; $tne = '</div>';
                return TAGPARSER_RET_REPLACED;
                break;
            case 'center':
                $tns = '<div style="width:100%;text-align:center" align="center">'; $tne = '</div>';
                return TAGPARSER_RET_REPLACED;
                break;
            case 'right':
                $tns = '<div style="width:100%;text-align:right" align="right">'; $tne = '</div>';
                return TAGPARSER_RET_REPLACED;
                break;
            case 'justify':
                $tns = '<div style="width:100%;text-align:justify" align="justify">'; $tne = '</div>';
                return TAGPARSER_RET_REPLACED;
                break;
            case 'indent':
            ...
            case 'url':
                ...
                if(isset($tag->options['default'])) {
                    ...
                    $tns = "<a href='".htmlspecialchars($tempstr, ENT_QUOTES)."' target='_blank'>"; $tne = '</a>';
                    return TAGPARSER_RET_REPLACED;
                }
                break;
            case 'thread':
...
///////////////////////////////////////////
            ...
            case 'video':
                ...
                $vid_minwidth = 20; $vid_minheight = 20;             
                $vid_maxwidth = (int)$GLOBALS["fbConfig"]["rtewidth"]; $vid_maxheight = 480;
                ...
                $vid_provider = array(
                    'animeepisodes' => array ('flash', 428, 352, 0, 0, 'http://video.animeepisodes.net/vidiac.swf', array(
                        array(6, 'flashvars', 'video='.$between))),
                    'biku' => array ('flash', 450, 364, 0, 0, 'http://www.biku.com/opus/player.swf?VideoID='.$between.'&embed=true&autoStart=false'),
                    'bofunk' => array ('flash', 446, 370, 0, 0, 'http://www.bofunk.com/e/'.$between),
                    'break' => array ('flash', 464, 392, 0, 0, 'http://embed.break.com/'.$between),
                    'clipfish' => array ('flash', 464, 380, 0, 0, 'http://www.clipfish.de/videoplayer.swf?as=0&videoid='.$between.'&r=1&c=0067B3'),
                    'collegehumor' => array ('flash', 480, 360, 0, 0, 'http://www.collegehumor.com/moogaloop/moogaloop.swf?clip_id='.$between.'&fullscreen=1'),
                    'current' => array ('flash', 400, 400, 0, 0, 'http://current.com/e/'.$between),
                    'dailymotion' => array ('flash', 420, 331, 0, 0, 'http://www.dailymotion.com/swf/'.$between),
                    'flashvars' => array ('flash', 480, 360, 0, 0, $between, array(
                        array(6, 'flashvars', $vid['param']))),
                    'fliptrack' => array ('flash', 402, 302, 0, 0, 'http://www.fliptrack.com/v/'.$between),
                    'gametrailers' => array ('flash', 480, 392, 0, 0, 'http://www.gametrailers.com/remote_wrap.php?mid='.$between),
                    'gamevideos' => array ('flash', 420, 405, 0, 0, 'http://www.gamevideos.com/swf/gamevideos11.swf?embedded=1&fullscreen=1&autoplay=0&src=http://www.gamevideos.com/video/videoListXML%3Fid%3D'.$between.'%26adPlay%3Dfalse', array(
                        array(6, 'bgcolor', '#000000'), array(6, 'wmode', 'window'))),
                    'gmx' => array ('flash', 425, 367, 0, 0, 'http://video.gmx.net/movie/'.$between),
                    'google' => array ('flash', 400, 326, 0, 0, 'http://video.google.com/googleplayer.swf?docId='.$between),
                    'ifilm' => array ('flash', 448, 365, 0, 0, 'http://www.ifilm.com/efp', array(
                        array(6, 'flashvars', 'flvbaseclip='.$between))),
                    'jumpcut' => array ('flash', 408, 324, 0, 0, 'http://jumpcut.com/media/flash/jump.swf?id='.$between.'&asset_type=movie&asset_id='.$between.'&eb=1'),
                    'liveleak' => array ('flash', 450, 370, 0, 0, 'http://www.liveleak.com/player.swf', array(
                        array(6, 'flashvars', 'autostart=false&token='.$between))),
                    'megavideo' => array ('flash', 432, 351, 0, 0, 'http://www.megavideo.com/v/'.$between.'..0'),
                    'metacafe' => array ('flash', 400, 345, 0, 0, 'http://www.metacafe.com/fplayer/'.$between.'/.swf'),
                    'mofile' => array ('flash', 480, 395, 0, 0, 'http://tv.mofile.com/cn/xplayer.swf', array(
                        array(6, 'flashvars', 'v='.$between.'&autoplay=0&nowSkin=0_0'))),
                    'myspace' => array ('flash', 430, 346, 0, 0, 'http://lads.myspace.com/videos/vplayer.swf', array(
                        array(6, 'flashvars', 'm='.$between.'&v=2&type=video'))),
                    'myvideo' => array ('flash', 470, 406, 0, 0, 'http://www.myvideo.de/movie/'.$between),
                    'quxiu' => array ('flash', 437, 375, 0, 0, 'http://www.quxiu.com/photo/swf/swfobj.swf?id='.$between, array(
                        array(6, 'menu', 'false'))),
                    'revver' => array ('flash', 480, 392, 0, 0, 'http://flash.revver.com/player/1.0/player.swf?mediaId='.$between),
                    'sevenload' => array ('flash', 425, 350, 0, 0, 'http://sevenload.com/pl/'.$between.'/425x350/swf', array(
                        array(6, 'flashvars', 'apiHost=api.sevenload.com&showFullScreen=1'))),
                    'stage6' => array ('divx', 480, 360, 0, 25, 'http://video.stage6.com/'.$between.'/.divx', array(
                        array(6, 'custommode', 'Stage6'))),
                    'stickam' => array ('flash', 400, 300, 0, 0, 'http://player.stickam.com/flashVarMediaPlayer/'.$between),
                    'streetfire' => array ('flash', 428, 352, 0, 0, 'http://videos.streetfire.net/vidiac.swf', array(
                        array(6, 'flashvars', 'video='.$between))),
                    'tudou' => array ('flash', 400, 300, 0, 0, 'http://www.tudou.com/v/'.$between),
                    'uume' => array ('flash', 400, 342, 0, 0, 'http://www.uume.com/v/'.$between.'_UUME'),
                    'veoh' => array ('flash', 540, 438, 0, 0, 'http://www.veoh.com/videodetails2.swf?player=videodetailsembedded&type=v&permalinkId='.$between),
                    'vidiac' => array ('flash', 428, 352, 0, 0, 'http://www.vidiac.com/vidiac.swf', array(
                        array(6, 'flashvars', 'video='.$between))),
                    'vimeo' => array ('flash', 400, 321, 0, 0, 'http://www.vimeo.com/moogaloop.swf?clip_id='.$between.'&server=www.vimeo.com&fullscreen=1&show_title=1&show_byline=1&show_portrait=0&color='),
                    'wangyou' => array ('flash', 441, 384, 0, 0, 'http://v.wangyou.com/images/x_player.swf?id='.$between),
                    'web.de' => array ('flash', 425, 367, 0, 0, 'http://video.web.de/movie/'.$between),
                    'youtube' => array ('flash', 425, 355, 0, 0, 'http://www.youtube.com/v/'.$between.'&rel=1'),
                    '_default' => array ($vid["type"], 480, 360, 0, 25, $between)
                );
                list($vid_type, $vid_width, $vid_height, $vid_addx, $vid_addy, $vid_source, $vid_par2) =
                    (isset($vid_provider[$vid["type"]]))?$vid_provider[$vid["type"]]:$vid_provider["_default"]; 
                ...
                switch ($vid_type) {
                    ...
                    case 'flash':
                        $vid_par1 = array(
                            ...
                            array(6, 'quality', 'high'), array(6, 'wmode', 'transparent'),
                            array(6, 'allowFullScreen', 'true'), array(6, 'allowScriptAccess', 'never'),
                            array(5, 'width', $vid_width), array(5, 'height', $vid_height));
                        break;
                    case 'mediaplayer':
                        $vid_par1 = array(
