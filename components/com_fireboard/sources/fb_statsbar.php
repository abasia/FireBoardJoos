...
class phpGraph
{
    ...
    function BarGraphHoriz()
    {
        ...
        echo '<div class="viewcover" align="center" style="text-align:center">';
        foreach ($this->_values as $value)
        {
            if ($this->_ShowLabels)
            {
            ...
            echo '<td width="' . $this->_GraphWidth . '" align="center">';
            echo '<img align="center" src="' . $this->_BarImg . '" height="' . $height . '" width="' . $width . '"';
            echo ' alt="" style="border:'.$this->_BarBorderWidth.'px solid '.$this->_BarBorderColor.'"/>';
            if ($rest_width > 0)
            {
                echo '<img align="center" src="' . $this->_BarImg2 . '" height="' . $height . '" width="' . ($rest_width - 4) . '"';
                echo ' alt="" style="border:'.$this->_BarBorderWidth.'px solid '.$this->_BarBorderColor.'"/>';
            }
            echo '</td></tr>';
        }
